<div class="formatted-content">
	<div>
		...
		<div class="join-now">
			<!--<sec:authorize access="isAuthenticated()">
				<p><a href="<?= base_url("/membership/index") ?>">Join Online in Member Area</a></p>
			</sec:authorize>
			<sec:authorize access="!isAuthenticated()">
				<p><a href="<?= base_url("/account/logOn")?>">Login</a></p> 
				<p>or</p>
				<p><a href="<?= base_url("/account/create")?>">Create an Account</a></p>
			</sec:authorize>-->
		</div>
	</div>
	<hr />
	<div>
		...
		<ol>
			<li>
				<a href="<?= base_url("/Content/files/attach/1112_YFSC_Spring_Renewal.pdf")?>">Spring Registration Form for Current Members</a><br />
				Use this form to subscribe to Spring term skating sessions.<br />
			</li>
			<li>
				<a href="<?= base_url("/Content/files/attach/1112_YFSC_Mbrship_FormSpring.pdf")?>">Combined Membership and Registration Form for New Members</a><br />
			...
			<li>
				<a href="<?= base_url("/Content/files/attach/Emergency_Form.pdf")?>">Emergency Information</a><br />
